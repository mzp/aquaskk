...
public struct SKKKeyState: Equatable, Hashable {
    ...
    static public func KeyCode(_ keyCode: Int32, _ mods: SKKKeyModifier) -> SKKKeyState {
        return Self.init(charCode: 0, keyCode: Int(keyCode), mods: mods)
    }

    static public func CharCode(_ charCode: Int32, _ mods: SKKKeyModifier) -> SKKKeyState {
        Self.init(charCode: Int(charCode), keyCode: 0, mods: mods)
    }
