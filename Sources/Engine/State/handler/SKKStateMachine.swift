...
public class SKKStateMachineImpl {
    ...
    init(engine: SKKInputEngineImpl, context: SKKInputContext, config: SKKConfig, completer: SKKCompleterImpl, selector: SKKSelectorImpl, messenger: SKKMessengerProtocol) {
