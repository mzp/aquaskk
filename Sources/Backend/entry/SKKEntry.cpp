...
std::string SKKEntry::ToggleKana(SKKInputMode mode) const {
    ...
    case SKKInputMode::HirakanaInputMode:
        SKKTransliterate::hirakana_to_katakana(normal_entry_, result);
        break;

    case SKKInputMode::KatakanaInputMode:
        SKKTransliterate::katakana_to_hirakana(normal_entry_, result);
        break;

    case SKKInputMode::Jisx0201KanaInputMode:
        SKKTransliterate::jisx0201_kana_to_katakana(normal_entry_, result);
        break;
...
std::string SKKEntry::ToggleJisx0201Kana(SKKInputMode mode) const {
    ...
    switch(mode) {
    case SKKInputMode::HirakanaInputMode:
        SKKTransliterate::hirakana_to_jisx0201_kana(normal_entry_, result);
        break;

    case SKKInputMode::KatakanaInputMode:
        SKKTransliterate::katakana_to_jisx0201_kana(normal_entry_, result);
        break;

    case SKKInputMode::Jisx0201KanaInputMode:
        SKKTransliterate::jisx0201_kana_to_hirakana(normal_entry_, result);
        break;

    case SKKInputMode::AsciiInputMode:
        SKKTransliterate::ascii_to_jisx0208_latin(normal_entry_, result);
        break;
...
SKKEntry SKKEntry::Normalize(SKKInputMode mode) const {
    ...
    case SKKInputMode::KatakanaInputMode:
        SKKTransliterate::katakana_to_hirakana(normal_entry_, result);
        SKKTransliterate::katakana_to_roman(kana_, roman);
        break;

    case SKKInputMode::Jisx0201KanaInputMode:
        SKKTransliterate::jisx0201_kana_to_hirakana(normal_entry_, result);
        SKKTransliterate::jisx0201_kana_to_roman(kana_, roman);
        break;

    default:
        SKKTransliterate::hirakana_to_roman(kana_, roman);
        break;
    }
